...
const ExperienceItem: React.FC<ExperienceItemProps> = ({ experience }) => {
  return (
    <Box sx={{ mb: 3 }}>
      ...
      {experience.positions && experience.positions.map((pos, index) => (
        <Typography 
          key={index} 
          component="div" 
          color="primary.main" 
      ...
      >
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Typography variant="body1">
            {resumeData.personalInfo.phone} • {resumeData.personalInfo.email} • {resumeData.personalInfo.website}
          </Typography>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <SkillSection title="Frontend" items={resumeData.skills.frontend} />
            <SkillSection title="Backend" items={resumeData.skills.backend} />
            <SkillSection title="Platform & Architecture" items={resumeData.skills.platformArchitecture} />
